document.addEventListener('DOMContentLoaded', function() {
    ...
    inventoryForm.addEventListener('submit', function(event) {
        ...
        localStorage.setItem('inventory2', JSON.stringify(inventoryData));

        // Exibir mensagem personalizada
        showMessage('Inventário 2: Dados salvos com sucesso! 🎉');
    });
    ...
    exportButton.addEventListener('click', function(event) {
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'Inventário 2');
        XLSX.writeFile(wb, 'inventario2.xlsx');
    });
